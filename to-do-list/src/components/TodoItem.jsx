...
function TodoItem({ todo }) {
  ...
  useEffect(() => {
    console.log('Tarefa renderizado!');
  }, []);
      ...
      <button
        onClick={() => {
          ...
          if (window.confirm('Tem certeza que deseja remover esta tarefa?')) {
            ...
            console.info('Tarefa removida com sucesso.');
            return;
          } else {
            alert('Ação cancelada!');
            console.info('Ação cancelada.');
            return;
          }
        }}
        className="px-3 md:px-4 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700"
      >
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="size-4 md:size-5 stroke-2"
        >
          <path
            strokeLinecap="round"
